...
contract GoodGhosting_Aave_Polygon is Ownable, Pausable, GoodGhostingWhitelisted {
    ...
    // removed immutable due to a stack too deep error in constructor
    ...
    constructor(
        ...
        // using daiToken duee to stack too deep error
